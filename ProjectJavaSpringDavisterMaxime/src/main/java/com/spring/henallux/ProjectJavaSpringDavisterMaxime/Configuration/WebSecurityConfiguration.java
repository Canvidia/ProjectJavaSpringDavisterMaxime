...
public class WebSecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    private static final String[] AUTHORIZED_REQUESTS_ANYBODY = new String[]{
            "/image/**","/bootstrap/css/**","/bootstrap/js/**", "/translations/**",
            "/","/caddie","/caddie/remove/**","/catalogue","/produit_info/**",
            "/infos","/inscription/**","/login"
    };
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http
                ...
                //.logoutUrl("/CheminDeTraverse/logout")// = valeur "/bidon/logout" à écrire dans action du formulaire ou dans le lien - par défaut = "logout" (sans /)
